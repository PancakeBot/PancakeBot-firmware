...
// #define RAMPS_V_1_0
  ...
  #define LARGE_FLASH true
    ...
    #define X_MIN_PIN            28////3
    #define X_MAX_PIN            -1////2       
    
    #define Y_STEP_PIN          60////60
    #define Y_DIR_PIN            61////61
    #define Y_ENABLE_PIN      56////56
    #define Y_MIN_PIN            40////14
    #define Y_MAX_PIN            -1////15     22
    ...
    #define KILL_PIN           -1
    #define HEATER_0_PIN       14   // EXTRUDER 1
    #define HEATER_1_PIN       -1
    #define HEATER_2_PIN       -1
    #define TEMP_0_PIN         15   // ANALOG NUMBERING
    #define TEMP_1_PIN         16   // ANALOG NUMBERING
    #define TEMP_2_PIN         -1   // ANALOG NUMBERING
    #define HEATER_BED_PIN     58    // BED
    #define TEMP_BED_PIN       16   // ANALOG NUMBERING
    #define DOGLCD_SCK      23
    #define DOGLCD_MOSI     64
    #define DOGLCD_CS       63
    #define DOGLCD_A0       66
    #define DOGLCD_BACK    65
    #define LED_POWERON      5
    #define LED_POWEROFF    6
    #define LED_SDERROR       8
    #define LED_WORKING       7
    //KEY DEFINE
    #define BTN_ENCADD            10
    #define BTN_ENCPOWER       11
    #define BTN_ENCDOWN         3
    #define BTN_ENCSTART        13
    #define BTN_EN1 10
    #define BTN_EN2 3
    #define BTN_ENC 13
    #define BTN_END -1//11
